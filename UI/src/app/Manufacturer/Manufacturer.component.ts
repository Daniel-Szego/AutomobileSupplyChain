...
export class ManufacturerComponent implements OnInit {
  ...
  partStorage = new FormControl('', Validators.required);
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.automobilesupplychain.basic.Manufacturer',
      'carType': this.carType.value,
      'partStorage': this.partStorage.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceManufacturer.updateParticipant(form.get('id').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.partStorage) {
        formObject.partStorage = result.partStorage;
      } else {
        formObject.partStorage = null;
      }
